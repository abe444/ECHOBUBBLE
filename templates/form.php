<div class="postingFORM">
        ...
        <form method="POST" id="POST" action="posting.php">
            ...
            <textarea spellcheck="true" required="" rows="10" cols="55" name="message" maxlength="<?php echo $CONFIGURATION['MAX_MESSAGE_LENGTH'] ?>" placeholder="Character limit: <?php echo $CONFIGURATION['MAX_MESSAGE_LENGTH'] ?>"></textarea>
